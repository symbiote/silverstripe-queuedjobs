---
title: Performance
summary: Improving the performance of queued jobs
icon: tachometer-alt
---
...
See [alternative runners](./06_configuring-runners.md)
...
[clear out old job entries](./01_overview.md#cleaning-up)
regularly.
...
[`DoormanRunner`](api:Symbiote\QueuedJobs\Tasks\Engines\DoormanRunner)
supports multi process execution through the
[asyncphp/doorman](https://github.com/silverstripe/doorman/) library.
...
See [Defining Jobs](./02_defining-jobs.md) for different ways to create jobs.
